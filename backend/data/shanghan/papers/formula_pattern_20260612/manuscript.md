# 基於條文級規則挖掘與自主審核的《傷寒論》方證規律挖掘：以桂枝湯類方證演化為例

## 摘要

目的：將《傷寒論》宋本條文轉化為可回源、可審核的結構化規則體系，並以桂枝湯類方證演化為例驗證方法可行性。
...
| 方劑 | 核心證 | 核心脈 | 條文 | 等級 |
|---|---|---|---|---|
| 柴胡桂枝乾薑湯 | 小便不利、渴、頭汗出、往來寒熱 | — | SHL_SONGBEN_0147 | silver |
...
茲投稿論文《基於條文級規則挖掘與自主審核的《傷寒論》方證規律挖掘：以桂枝湯類方證演化為例》。本研究首次將「逐字證據回源 + 對抗式自主審核」
