---
name: hermes.formula.shaoyaogancaofuzi_tang
description: 芍藥甘草附子湯方證規則：核心證候、脈象、組成、煎服法、加減方與禁忌，全部回源條文。
formula: 芍藥甘草附子湯
formula_family: 附子湯
...
| 項目 | 內容 | 證據層 |
|---|---|---|
| 核心病類 | 太陽病芍藥甘草附子湯證 | 歸納（D/E） |
| 六經歸屬 | 太陽病 | 原文章節（A） |
| 核心症狀 | 反惡寒 | 跨條歸納自原文（A→D） |
| 核心脈象 | — | 跨條歸納自原文（A→D） |
| 兼證 | — | 跨條歸納自原文（A→D） |
