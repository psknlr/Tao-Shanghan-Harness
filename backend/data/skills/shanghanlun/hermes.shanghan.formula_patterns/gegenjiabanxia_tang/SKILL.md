---
name: hermes.formula.gegenjiabanxia_tang
description: 葛根加半夏湯方證規則：核心證候、脈象、組成、煎服法、加減方與禁忌，全部回源條文。
formula: 葛根加半夏湯
formula_family: 葛根湯
...
（SHL_SONGBEN_0033，辨太陽病脈證並治中）

> 葛根加半夏湯方
（SHL_SONGBEN_AUX_0242，辨發汗吐下後脈證並治第二十二）
